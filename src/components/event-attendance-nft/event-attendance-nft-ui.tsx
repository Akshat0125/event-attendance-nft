...
export function EventAttendanceNftUi() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8 py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
      ...
      {cluster.name !== 'devnet' && (
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-3.5 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-amber-200 text-xs sm:text-sm">
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-amber-600 hover:bg-amber-700 text-white font-semibold shrink-0 text-xs sm:text-sm"
          >
            Switch to Devnet
          </Button>
        </div>
      ...
      {/* Hero Header */}
      <div className="text-center space-y-3 bg-gradient-to-r from-purple-900/30 via-indigo-900/30 to-blue-900/30 p-4 sm:p-6 md:p-8 rounded-2xl border border-indigo-500/20 backdrop-blur-md">
        ...
        <p className="max-w-2xl mx-auto text-neutral-400 text-xs sm:text-base">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-4 text-xs font-mono pt-2 text-neutral-500">
          <div className="break-all text-center">Program ID: <span className="text-indigo-400">{programId.toBase58()}</span></div>
      ...
      {!publicKey ? (
        <div className="text-center py-8 sm:py-12 px-4 bg-neutral-900/50 rounded-xl border border-neutral-800 space-y-4">
          <h2 className="text-base sm:text-lg font-medium text-neutral-300">Connect your wallet to get started</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {/* Organizer Card */}
          <div className="bg-neutral-900/80 border border-neutral-800 rounded-xl p-4 sm:p-6 space-y-4 sm:space-y-5 shadow-xl">
            <div className="flex items-center gap-3 border-b border-neutral-800 pb-4">
              <Calendar className="w-6 h-6 text-purple-400 shrink-0" />
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-white">Organizer: Create Event</h2>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="event-name" className="text-neutral-300 text-xs sm:text-sm">Event Name</Label>
                <Input
                  id="event-name"
                  value={eventName}
                  onChange={(e) => setEventName(e.target.value)}
                  placeholder="e.g. Solana Hacker House"
                  className="bg-neutral-950 border-neutral-800 text-white text-xs sm:text-sm"
                />
              </div>

              <div className="space-y-1 text-xs text-neutral-500 break-all">
              ...
              <Button
                ...
                className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium text-xs sm:text-sm py-2.5 sm:py-3"
              >
          ...
          <div className="bg-neutral-900/80 border border-neutral-800 rounded-xl p-4 sm:p-6 space-y-4 sm:space-y-5 shadow-xl">
            <div className="flex items-center gap-3 border-b border-neutral-800 pb-4">
              ...
              <div>
                <h2 className="text-base sm:text-lg font-semibold text-white">Attendee: Check-In</h2>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="checkin-event-name" className="text-neutral-300 text-xs sm:text-sm">Event Name</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="organizer-pubkey" className="text-neutral-300 text-xs sm:text-sm">
                  Organizer Address <span className="text-neutral-500 text-xs block sm:inline">(optional - defaults to current wallet)</span>
                </Label>
                <Input
                  id="organizer-pubkey"
                  ...
                  className="bg-neutral-950 border-neutral-800 text-white font-mono text-xs truncate"
                />
              </div>
              ...
              <Button
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-xs sm:text-sm py-2.5 sm:py-3"
              >
      ...
      <div className="bg-neutral-900/60 border border-neutral-800 rounded-xl p-4 sm:p-6 space-y-4">
        <h3 className="text-sm sm:text-base font-semibold text-white flex items-center gap-2">
          <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0" /> Badge Design & Fixed IPFS Metadata
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs text-neutral-400">
